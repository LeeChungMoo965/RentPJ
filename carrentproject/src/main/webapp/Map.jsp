...
for (var i = 0; i < carPositions.length; i++) {
    ...
    kakao.maps.event.addListener(carMarker, 'click', makeClickListener(map, carMarker, carPositions[i].title, carPositions[i].carprice,carPositions[i].carid, carPositions[i].day1, carPositions[i].day2));
    
    markerBounds.extend(markerPosition);
    hasValidMarkers = true;
}

function makeClickListener(map, marker, title,carprice,carid,day1,day2) {
